...
public class BuddyListField extends ObjectListField{
    ...
    public static final Bitmap offlineIconSmall = Bitmap.getBitmapResource("img/grey_ball.png");
    public static final Bitmap reloading = Bitmap.getBitmapResource("img/reloading.png");
    public static final Bitmap awayIconSmall = Bitmap.getBitmapResource("img/yellow_ball.png");
    public static final Bitmap busyIconSmall = Bitmap.getBitmapResource("img/red_ball.png");
    public static final Bitmap onlineIconSmall = Bitmap.getBitmapResource("img/green_ball.png");
    
    public static final Bitmap offlineIcon = Bitmap.getBitmapResource("img/grey_ball.png");
    public static final Bitmap awayIcon = Bitmap.getBitmapResource("img/yellow_ball.png");
    public static final Bitmap busyIcon = Bitmap.getBitmapResource("img/red_ball.png");
    public static final Bitmap onlineIcon = Bitmap.getBitmapResource("img/green_ball.png");
    public static final Bitmap unreadIcon = Bitmap.getBitmapResource("img/blue_ball.png");
    public static final Bitmap fssave = Bitmap.getBitmapResource("img/fs_save.png");
    public static final Bitmap VoiceIcon = Bitmap.getBitmapResource("img/mime_audio.png");

	public static final Bitmap[] statusIcon = new Bitmap[]{offlineIcon, awayIcon, busyIcon, onlineIcon, VoiceIcon};
...
//		}
	...
	public void drawListRow(ListField listField, Graphics graphics, int index, int y, int width) {
		...
		if (b.unread) {
		    ...
		    graphics.drawBitmap(0, y-2, 32, 32, unreadIcon, 0, 0);
		} else {
		    ...
		    graphics.drawBitmap(0, y-2, 32, 32, statusIcon[b.status], 0, 0);
		}
		...
		graphics.drawText("  " + b.name, 34, y, DrawStyle.ELLIPSIS, width-16);
	}
